# Tutorial 1: Create a database, schema, table, and warehouse [¶](https://docs.snowflake.com/en/developer-guide/snowflake-python-api/tutorials/tutorial-1\#tutorial-1-create-a-database-schema-table-and-warehouse "Link to this heading")

## Introduction [¶](https://docs.snowflake.com/en/developer-guide/snowflake-python-api/tutorials/tutorial-1\#introduction "Link to this heading")
...
### Prerequisites [¶](https://docs.snowflake.com/en/developer-guide/snowflake-python-api/tutorials/tutorial-1\#prerequisites "Link to this heading")

Note

If you have already completed the steps in [Common setup for Snowflake Python APIs tutorials](https://docs.snowflake.com/en/developer-guide/snowflake-python-api/tutorials/common-setup), you can skip these prerequisites and proceed to the first step of this
tutorial.

Before you start this tutorial, you must complete the [common setup](https://docs.snowflake.com/en/developer-guide/snowflake-python-api/tutorials/common-setup) instructions, which includes the following steps:
...
## Create a database, schema, and table [¶](https://docs.snowflake.com/en/developer-guide/snowflake-python-api/tutorials/tutorial-1\#create-a-database-schema-and-table "Link to this heading")
...
For more information, see [Managing Snowflake databases, schemas, tables, and views with Python](https://docs.snowflake.com/en/developer-guide/snowflake-python-api/snowflake-python-managing-databases).

2. Sign in to [Snowsight](https://docs.snowflake.com/en/user-guide/ui-snowsight-gs.html#label-snowsight-getting-started-sign-in).
...
## Retrieve object data [¶](https://docs.snowflake.com/en/developer-guide/snowflake-python-api/tutorials/tutorial-1\#retrieve-object-data "Link to this heading")
...
## Programmatically alter a table [¶](https://docs.snowflake.com/en/developer-guide/snowflake-python-api/tutorials/tutorial-1\#programmatically-alter-a-table "Link to this heading")
...
## Create and manage a warehouse [¶](https://docs.snowflake.com/en/developer-guide/snowflake-python-api/tutorials/tutorial-1\#create-and-manage-a-warehouse "Link to this heading")
...
## What’s next? [¶](https://docs.snowflake.com/en/developer-guide/snowflake-python-api/tutorials/tutorial-1\#what-s-next "Link to this heading")
...
### Summary [¶](https://docs.snowflake.com/en/developer-guide/snowflake-python-api/tutorials/tutorial-1\#summary "Link to this heading")
...
### Next tutorial [¶](https://docs.snowflake.com/en/developer-guide/snowflake-python-api/tutorials/tutorial-1\#next-tutorial "Link to this heading")

You can now proceed to [Tutorial 2: Create and manage tasks and task graphs (DAGs)](https://docs.snowflake.com/en/developer-guide/snowflake-python-api/tutorials/tutorial-2), which shows how to create and manage tasks and task graphs.

### Additional resources [¶](https://docs.snowflake.com/en/developer-guide/snowflake-python-api/tutorials/tutorial-1\#additional-resources "Link to this heading")

For more examples of using the API to manage other types of objects in Snowflake, see the following developer guides:

| Guide | Description |
| --- | --- |
| [Managing Snowflake users, roles, and grants with Python](https://docs.snowflake.com/en/developer-guide/snowflake-python-api/snowflake-python-managing-user-roles) | Use the API to create and manage users, roles, and grants. |
| [Managing data loading and unloading resources with Python](https://docs.snowflake.com/en/developer-guide/snowflake-python-api/snowflake-python-managing-data-loading) | Use the API to create and manage data loading and unloading resources, including external volumes, pipes, and stages. |
| [Managing Snowflake tasks and task graphs with Python](https://docs.snowflake.com/en/developer-guide/snowflake-python-api/snowflake-python-managing-tasks) | Use the API to create, execute, and manage tasks and task graphs. |
| [Managing Snowpark Container Services (including service functions) with Python](https://docs.snowflake.com/en/developer-guide/snowflake-python-api/snowflake-python-managing-containers) | Use the API to manage components of Snowpark Container Services, including compute pools, image repositories, services, and service<br>functions. |

[Next\\
Create a database, schema, and table](https://docs.snowflake.com/en/developer-guide/snowflake-python-api/tutorials/tutorial-1#create-a-database-schema-and-table)

Language: **English**

[English](https://docs.snowflake.com/en/developer-guide/snowflake-python-api/tutorials/tutorial-1)
[Français](https://docs.snowflake.com/fr/developer-guide/snowflake-python-api/tutorials/tutorial-1)
[Deutsch](https://docs.snowflake.com/de/developer-guide/snowflake-python-api/tutorials/tutorial-1)
[日本語](https://docs.snowflake.com/ja/developer-guide/snowflake-python-api/tutorials/tutorial-1)
[한국어](https://docs.snowflake.com/ko/developer-guide/snowflake-python-api/tutorials/tutorial-1)
[Português](https://docs.snowflake.com/pt/developer-guide/snowflake-python-api/tutorials/tutorial-1)